...
- **Frontend**: React-based UI that displays metrics with auto-refreshing gauges
...
![Docker Build Pipeline](https://github.com/PrasiddhaBhattarai/system-monitor/actions/workflows/docker-build-push.yml/badge.svg)

![Matrix Docker Build and Push](https://github.com/PrasiddhaBhattarai/system-monitor/actions/workflows/docker-build-push-matrix.yml/badge.svg)
